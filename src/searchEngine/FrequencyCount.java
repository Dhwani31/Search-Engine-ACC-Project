...
public class FrequencyCount { 
	...
	public static  Hashtable<String, Integer> WordCount() throws IOException
	{
		...
		try 
		{
			...
			File myFolder = new File("C:\\Users\\hanik\\eclipse-workspace\\Web-Search-Engine-Project-main\\Web-Search-Engine-Project-main\\convertedWebPages"); //reading the converted text files
