...
public class WebCrawler 
{
	...
	public static void createFile(String title,String text,String link) 
	{
		try {
			...
			File f = new File("C:\\Users\\hanik\\eclipse-workspace\\Web-Search-Engine-Project-main\\Web-Search-Engine-Project-main\\WebPages\\convertedWebPages\\"+newTitle+".txt");            // create text file in convertedWebPages folder
			f.createNewFile();			
	...
	public static void crawlPages(String links) 
	{
		...
		try {
			File f = new File("CrawledPages.txt");                         // stores the linnks of crawled pages
			f.createNewFile();
	...
	public static void main(String[] args) {
		String links="https://www.leadinfosoft.com/";   //crawls the  mentioned link
		crawlPages(links);
	}
}
